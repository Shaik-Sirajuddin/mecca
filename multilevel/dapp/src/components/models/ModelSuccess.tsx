...
const ModalSuccess = ({ title, description, onClose, show }: Props) => {
  function close() {
    onClose();
  }
  ...
  return (
    <>
      <Dialog
        ...
        onClose={close}
      >
        <div className="fixed inset-0 z-50 w-screen overflow-y-auto blurred-background">
          <div className="flex min-h-full items-center justify-center p-3">
            <DialogPanel
              transition
              style={{
                background:
                  "linear-gradient(107.1deg, #222226 18.53%, #323237 51.47%, #222226 79.58%)",
              }}
            ...
            >
              <div className="w-full max-w-[310px] py-11 mx-auto">
                <DialogTitle
                  as="h3"
                  className="text-2xl font-medium text-center text-green3"
                >
                  {title}
                </DialogTitle>
