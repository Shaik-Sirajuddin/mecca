      ...
      <nav className="w-full max-w-[1162px] px-4 mx-auto bg-pink10 lg:rounded-lg py-3 backdrop-blur-lg border border-white/20">
        <div className="w-full flex items-center justify-between gap-10">
          ...
          <div className="flex items-center gap-4 relative z-20">
            <button
              type="button"
              className="relative transition-all duration-200 hover:text-gray-300  lg:max-w-[137px] max-w-[70px] inline-flex items-center justify-center rounded font-bold lg:text-sm text-[10px] text-white font-poppins"
