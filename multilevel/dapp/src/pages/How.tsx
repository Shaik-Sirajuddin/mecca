          ...
          {/* Start TeamBee Changes: bg-black4 to bg-black5 */}
            ...
            <div className="w-full max-w-[1152px] mx-auto px-5">
                ...
                <div className="w-full flex items-center flex-col h-full bg-magenta3 rounded-full">
                  ...
                  <span className='md:text-sm text-[10px] text-white font-poppins font-medium'>STAGE C</span>
                  <span className='md:text-sm text-[10px] text-white font-poppins font-semibold'>Level 21 -  30</span>
                  </div>
                  ...
                  <span className='md:text-sm text-[10px] text-white font-poppins font-medium'>STAGE B</span>
                  <span className='md:text-sm text-[10px] text-white font-poppins font-semibold'>Level 21 -  20</span>
                  </div>
                  ...
                  <span className='md:text-sm text-[10px] text-white font-poppins font-medium'>STAGE A</span>
                  <span className='md:text-sm text-[10px] text-white font-poppins font-semibold'>Level 1 -  10</span>
                  <span className='md:text-base text-xs md:py-4 py-1 block text-white font-poppins font-semibold'>2,000 MEA</span>
                  </div>
                  </div>
                  <span className='md:text-base text-xs md:py-4 pt-3 block text-white font-poppins font-semibold'>10,000 MEA</span>
                  </div>
                  <span className='md:text-base text-xs text-white font-poppins font-semibold md:py-5 pb-3 pt-1'>30,000 MEA</span>
                </div>
            ...
            <h2 className='text-2xl text-magenta1 font-semibold text-center pb-14 uppercase'>REWARD TYPES</h2>
              ...
              <div className="w-full grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 xl:gap-14 lg:gap-0 gap-14  justify-center ">
                ...
                <div className="w-full max-w-[192px] relative text-center mx-auto">
                  ...
                  <p className='text-[10px] -translate-x-10 lg:translate-x-0 text-white font-medium mt-6 max-w-[150px] mx-auto'>of the referred user's payment amount</p>
                </div>
