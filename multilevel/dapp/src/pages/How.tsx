          ...
          <div className="w-full max-w-[1152px] mx-auto px-10 relative z-20">
            <div className="w-full text-center">
              ...
              <p className="text-base font-semibold leading-6 mb-5 text-white max-w-[974px] mx-auto mt-2">
                MECCA CRYPTO provides a sustainable network environment for
                participants based on technical transparency and stability.
                Participants can build strong communities with the users they
                invite, discover the value of collaboration, and share economic
                opportunities.
              </p>
              <p className="text-base font-semibold leading-6 text-white max-w-[974px] mx-auto mt-2">
                The moment you join the pool, you'll experience more than just
                rewards. MECCA CRYPTO will transform your efforts into the
                assets of the future and make the new economic possibilities of
                blockchain technology a reality. Usher in a new era of the
                digital economy with MECCA CRYPTO.
              </p>
            </div>
          </div>
            ...
            <div className="w-full text-center">
              <div className="md:max-w-[400px] max-w-[300px] flex flex-col gap-1.5 mx-auto">
                <div className="text-center inline-flex items-center md:px-0 px-24  justify-center mx-auto">
                  ...
                  <span className="absolute text-white md:text-sm text-[10px] font-medium mt-5">
                    STAGE A
                  </span>
                  <span className="absolute text-white md:text-sm text-[10px] font-semibold md:mt-16 mt-12">
                    2,000 MEA
                  </span>
                </div>
                <div className="text-center inline-flex items-center md:px-0 px-12 justify-center mx-auto">
                  ...
                  <span className="absolute text-white md:text-sm text-[10px] font-medium -mt-2">
                    STAGE B
                  </span>
                  <span className="absolute text-white md:text-sm text-[10px] font-semibold md:mt-10 mt-6">
                    10,000 MEA
                  </span>
                </div>
          ...
          <div className="w-full max-w-[1152px] mx-auto px-5">
            ...
            <div className="w-full grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-14  justify-center ">
              ...
              <div className="w-full max-w-[192px] relative text-center mx-auto">
                ...
                <p className="text-[10px] text-white font-medium mt-6 max-w-[150px] mx-auto">
