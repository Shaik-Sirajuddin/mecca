  ...
  return (
    <>
      ...
      <div className="w-full bg-black5 relative">
        ...
        <section className="w-full relative md:min-h-[600px] bg-black5/50  lg:min-h-[753px]  pb-28 pt-32 lg:pt-[92px]">
          <div className="w-full h-[100%] absolute top-0 left-0 bg-black z-10"></div>
