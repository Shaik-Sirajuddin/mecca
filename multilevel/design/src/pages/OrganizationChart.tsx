        ...
        <div className="w-full max-w-[1162px] mx-auto absolute h-[623px] rounded-full blur-[200px] -top-[400px] left-1/2 -translate-x-1/2 bg-[#6E3359]"></div>
           ...
           <section className='w-full relative md:min-h-[600px] lg:min-h-[753px] bg-[url(abstract-background-with-flowing.png)] bg-cover bg-top bg-no-repeat pb-28 pt-32 lg:pt-[254px]'>
            ...
            <div className="w-full text-center">
              ...
              <h1 className='text-[32px] lg:text-[94px] max-w-[710px] leading-tight mx-auto text-white font-dm-sans font-bold mb-16'>ORGANIZATION
              CHART</h1>
            </div>
            ...
            <div className="w-full max-w-[900px] min-w-[900px] mx-auto pt-[10px] flex flex-col items-center justify-center">
              <div className="w-full max-w-[234px] bg-[url(tree-chart-bg.png)] bg-no-repeat bg-full bg-center p-3 relative mb-12">
                <ul>
                  <li className='w-full flex items-center gap-5 justify-between mb-2'>
                    <p className='text-sm font-medium font-poppins text-white'>User ID</p>
                    <p className='text-sm font-medium font-poppins text-white'>45jk201fg</p>
                  </li>
                  <li className='w-full flex items-center gap-5 justify-between mb-2'>
                    <p className='text-sm font-medium font-poppins text-white'>Wallet address :</p>
                    <p className='text-sm font-medium font-poppins text-white'>45jk201fg</p>
                  </li>
                  <li className='w-full flex items-center gap-5 justify-between mb-2'>
                    <p className='text-sm font-medium font-poppins text-white'>Initial Stage :</p>
                    <p className='text-xs font-medium font-poppins text-white bg-green1 p-1 rounded'>STAGE A</p>
                  </li>
                  <li className='w-full flex items-center gap-5 justify-between mb-2'>
                    <p className='text-sm font-medium font-poppins text-white'>Current Stage :</p>
                    <p className='text-xs font-medium font-poppins text-white bg-pink1 p-1 rounded'>STAGE C</p>
                  </li>
                  <li className='w-full flex items-center gap-5 justify-between'>
                    <p className='text-sm font-medium font-poppins text-white'>Referral Reward :</p>
                    <p className='text-sm font-medium font-poppins text-white'>10 MEA</p>
                  </li>
                </ul>
                <img src="tree-lines.png" className='absolute -bottom-11 left-1/2 -translate-x-1/2 min-w-[431px] h-[45px]' alt="" />
              </div>
              ...
              <div className="w-full max-w-[234px] bg-[url(tree-chart-bg.png)] bg-no-repeat bg-full bg-center p-3 relative mb-12">
                ...
                <img src="tree-lines-2.png" className='absolute -bottom-11 left-1/2 -translate-x-1/2 min-w-[273px] h-[45px]' alt="" />
              </div>
              ...
              <div className="w-full max-w-[234px] bg-[url(tree-chart-bg.png)] bg-no-repeat bg-full bg-center p-3 relative mb-12">
                ...
                <img src="tree-line-right.png" className='absolute -bottom-11 ml-10 left-1/2 -translate-x-1/2 min-w-[100px] h-[45px]' alt="" />
              </div>
