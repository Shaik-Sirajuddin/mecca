...
export class DisReward implements IDisReward {
  ...
  static parse(data: IDisReward): DisReward {
    return new DisReward(data);
  }

  // Example dummy Reward for testing purposes
  static dummy(): DisReward {
    return new DisReward({
  ...
  static fromJSON(json: Record<string, any>): DisReward {
    return new DisReward({
